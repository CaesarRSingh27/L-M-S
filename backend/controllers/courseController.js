...
const toNumber = (v, fallback = 0) => {
    ...
    //Compute fiels for total lecture, course, duration
    //Mutate them and return as an object  
...
//Create image URL for stored value
...
export const rateCourse = async (req, res) => {
    try {
        ...
        const { rating: rawRating, comments= "" } = req.body;
    ...
    course.avgRating = avgRating; //If a particular course has multi user rating then it will calculate the average rating and total ratings and update the course document with that
