...
};//This function will calculate total time and override the manual input given by user.
...
const [currentChapter, setCurrentChapter] = useState({
  ...
  };//Similarly to lectures first validate the input fields then if ok create a lecture or
  // a chapter
  ...
  const submitToBackend = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/api/courses`, {
        method: "POST",
        body: fd,// That is the data that is appended 
      });
