...
export const coursePageStyles = {
  ...
  searchGradient: "relative",
  searchInputContainer: "flex items-center px-5 py-4 bg-white rounded-full border border-indigo-200 shadow-[0_0_15px_rgba(99,102,241,.15)] focus-within:shadow-[0_0_30px_rgba(99,102,241,.35)] focus-within:border-indigo-400 transition-all duration-300",
  searchIconContainer: "mr-3 flex items-center text-indigo-500",
  searchIcon: "w-5 h-5 text-blue-500 group-hover:text-indigo-600 transition-colors duration-500",
  searchInput: "flex-1 bg-transparent outline-none border-none text-slate-700",
  clearButton: "ml-3 text-gray-400 hover:text-red-500",
...
export const footerStyles = {
  ...
  brandGradient: "absolute -inset-3 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-2xl blur-lg opacity-20 transition-all duration-500 pointer-events-none z-0",
  brandTitle: "relative z-30 text-2xl sm:text-3xl font-bold text-slate-900 py-1",
...
export const footerBackgroundStyles = {
  backgroundContainer: "absolute inset-0 z-0 pointer-events-none",
  ...
  gridOverlay: "absolute inset-0 opacity-[0.02] pointer-events-none z-0"
};
