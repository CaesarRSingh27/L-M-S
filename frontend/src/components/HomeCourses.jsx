...
const HomeCourses = () => {
  ...
  const { title, course: courseFont, detail } =
  ...
  //For rating to set by user also show avg rating given by all users.
      ...
      <div className={homeCoursesStyles.mainContainer}>
              ...
              {courses.map((course) => {
                ...
                return (
                  <div
                    ...
                    className={homeCoursesStyles.courseGrid}
                  >
        ...
        <div className={homeCoursesStyles.ctaContainer}>
          <div className={homeCoursesStyles.ctaWrapper}>
            <span className={homeCoursesStyles.ctaGlow}></span>
            ...
            >
              <span className={homeCoursesStyles.ctaButtonContent}>
                ...
                <ArrowRight size={18} className={homeCoursesStyles.ctaButtonIcon} />
              </span>
            </button>
          </div>
        </div>
