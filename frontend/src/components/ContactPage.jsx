...
import { User, Mail, Phone, MessageSquare, MessageCircleDashed, SendHorizonal, MessageCircle } from "lucide-react"; 
...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/7376433661?text=${whatsappMessage}`;
            ...
            <div className={contactStyles.form}>
              ...
              >
                ...
                <div className={contactStyles.formGrid}>
                  ...
                  <div className={contactStyles.formGroup}>
                    ...
                    <input 
                      ...
                      onChange={handleChange} 
                      required 
                      className={`${contactStyles.input} ${contactStyles.colors.blue.focus} ${contactStyles.colors.blue.hover}`} // ✅ FIXED
                ...
                <div className={contactStyles.formGroup}>
                    ...
                    onChange={handleChange} required rows='5' className={`${contactStyles.textarea}
                ...
                <button type="submit" disabled={!isFormValid || isSubmitting} className={`${contactStyles.submitButton}
                    ${
                    isFormValid && !isSubmitting ? contactStyles.submitButtonEnabled : contactStyles.submitButtonDisabled
                    }`}>
                        {isSubmitting ? (
                            <>
